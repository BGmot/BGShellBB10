...
//qDebug("+++%s %d keyPressEvent and key is %d, modifiers=%x", __FILE__, __LINE__, event->key(), int(event->modifiers()));
	...
	if (bSymFlag){
		...
		case Qt::Key_S : c1[0] = 0xc3; c1[1] = 0xb7; break; //'�'
		...
		case Qt::Key_K : /*c = '�';*/ break; // Don't know how to pring -(
		case Qt::Key_L : /*c = '�';*/ break; // Don't know how to pring -(
		case Qt::Key_Z : c1[0] = 0xc2; c1[1] = 0xa5; break; // '�'
		case Qt::Key_X : c1[0] = 0xe2; c1[1] = 0x82; c1[2] =  0xac; break; // '�'
		case Qt::Key_C : c1[0] = 0xc2; c1[1] = 0xa3; break; // '�'
		case Qt::Key_V : c1[0] = 0xc2; c1[1] = 0xbf; break; // '�'
		case Qt::Key_B : c1[0] = 0xc2; c1[1] = 0xa1; break; // '�'
		case Qt::Key_N : c1[0] = 0xc2; c1[1] = 0xab; break; // '�'
		case Qt::Key_M : c1[0] = 0xc2; c1[1] = 0xbb; break; // '�'
